...
(function () {
  ...
  const CONTACT_EMAIL    = "support@grcind.com";
          ...
          <div class="contact-info reveal">
            <div class="contact-items">
              <a href="mailto:${CONTACT_EMAIL}" class="contact-item">
                ...
                <div><strong>Email Us</strong><span>${CONTACT_EMAIL}</span></div>
              </a>
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=${CONTACT_EMAIL}" target="_blank" class="contact-item">
                <div class="contact-item-icon ic-gmail"><i class="fab fa-google"></i></div>
                <div><strong>Gmail Support</strong><span>Open in Gmail &rarr;</span></div>
              </a>
              ...
              <div class="contact-item">
                <div class="contact-item-icon ic-purple"><i class="fas fa-clock"></i></div>
            ...
            <form id="contact-form" class="contact-form" novalidate>
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input id="cf-subject" type="text" name="subject" placeholder="Brief subject…" />
                </div>
              </div>
              <div class="form-group">
